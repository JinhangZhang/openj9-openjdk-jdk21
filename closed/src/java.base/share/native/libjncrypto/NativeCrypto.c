...
Java_jdk_crypto_jniprovider_NativeCrypto_PBKDF2_1derive
    (JNIEnv *env, jobject obj, jbyteArray password, jbyteArray salt, jint iterations, jint keyLength, jint hashAlgorithm) 
{
    const EVP_MD *digestAlgorithm = NULL;
    char *nativePassword = NULL;
    unsigned char *nativeSalt = NULL;
